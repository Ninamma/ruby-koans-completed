...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # The argument for inject is the starting number, which equals sum/product, then the relevant operations are carried out on it with the items, with the result as sum.
  end
