...
class AboutMessagePassing < Neo::Koan
  ...
  def test_send_with_underscores_will_also_send_messages
    ...
    #
    # Some classes define their own send methods
    # Can use both, but can easily override send, whereas overriding __send__ gives you a warning
  ...
  def test_calling_method_missing_causes_the_no_method_error
    ...
    #
    # You can use it to replace the NoMethodError with whatever you put in the method
    # http://rubylearning.com/satishtalim/ruby_method_missing.html
    # You might also need to override respond_to? and respond_to_missing?
    # https://makandracards.com/makandra/9821-when-overriding-method_missing-remember-to-override-respond_to_missing-as-well
    # NOTE:
    #
