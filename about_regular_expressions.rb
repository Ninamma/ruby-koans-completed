...
class AboutRegularExpressions < Neo::Koan
  ...
  #
  # Why?
  # Because it will get all the characters it can find, which might be more than what you want!
  # ------------------------------------------------------------------
  ...
  # Character class is faster than alternation because "OR" backtracks between the alternation
